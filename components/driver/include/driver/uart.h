...
#define UART(i)   ((uart_dev_t*)REG_UART_BASE(i))
//#define ETS_UART_INTR_ENABLE()  xt_ints_on(1 << ETS_UART0_INUM)
//#define ETS_UART_INTR_DISABLE() xt_ints_off(1 << ETS_UART0_INUM)
